...
/* Estilo para el contenedor que alinea el input y el icono */
.input-icon-wrapper {
    display: flex; /* Habilita Flexbox */
    align-items: center; /* Alinea verticalmente el input y el icono en el centro */
}

/* Opcional: Ajustar el input para que ocupe el espacio restante */
.input-icon-wrapper input[type="password"] {
    flex-grow: 1; /* Permite que el input crezca para usar el espacio disponible */
    margin-right: 10px; /* Añade un pequeño espacio entre el input y el icono */
}

/* Opcional: Ajustar el contenedor del icono para alinearlo mejor */
.ojo {
    /* Si el icono ya tiene un tamaño fijo (24x24px), no necesita más estilos */
        ...
        <form action="registro.php" method="POST">
            ...
            <div class="input-icon-wrapper">
               ...
               <input type="password" id="password" name="password" required autocomplete="new-password">
                <div class="ojo">
                <img src="imagenes/ojoCerrado.jpg" alt="ojo cerrado" style="width: 24px; height: 24px;">
                </div></br>
...
<script type="text/javascript">
    // 1. Corregido el selector: Ahora selecciona la etiqueta <img> dentro del div.ojo
    document.querySelector(".ojo img").addEventListener("click", ver);
    function ver() {
        // Obtenemos el tipo (password o text) actual del input
        let passwordInput = document.querySelector("#password");
        let eyeIcon = document.querySelector(".ojo img");
        let estado = passwordInput.getAttribute("type");
        if (estado === "password") {
            // 2. Corregido el setAtributte a setAttribute
            passwordInput.setAttribute("type", "text");
            // 3. Corregido el selector de la imagen a ".ojo img"
            eyeIcon.setAttribute("src", "imagenes/ojoAbierto.jpg");
        } else {
            // 4. Corregido el selector del input y el setAttribute
            passwordInput.setAttribute("type", "password");
            // 3. Corregido el selector de la imagen a ".ojo img" y el setAttribute
            eyeIcon.setAttribute("src", "imagenes/ojoCerrado.jpg");
        }
    }
</script>
</body>
